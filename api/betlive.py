...
logging.basicConfig(
    filename=os.path.join(LOG_DIR, 'scraper_bet_live_api.log'),
    filemode='w',
...
# API Endpoint
API_URL = "https://www.bet-live.ba/api/v1/prematch/offer?lang=hr"
...
def run():
    ...
    """
    logging.info("Starting scraper_bet_live_api.")
    ...
    try:
        ...
        excel_path = os.path.join("data", "bet_live.xlsx")
        pickle_path = os.path.join("pickle_data", "bet_live.pkl")
        ...
        logging.info("Scraper_bet_live_api has finished execution.")
